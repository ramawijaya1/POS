<?php
  ...
  include 'config.php';
    ...
    if(isset($_POST['login'])){
      ...
      $queryuser = mysqli_query($conn,"SELECT * FROM admin WHERE username='$user'");
...
<head>
    ...
    <title>Login Aplikasi Kasir | by.kelompok5</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      ...
      <br><p style="text-align:left"><a href="../Kasir/login.php" style="color:white">Login Sebagai Kasir</a></p>
