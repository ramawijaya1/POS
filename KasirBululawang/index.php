      ...
      <form action="transaksi_controller.php" method="post">
        ...
        <div class="row">
          ...
          <div class="col-8 col-sm-8 col-md-8 col-lg-9 mb-2">
            ...
            <input type="hidden" name="id_invoice" value="<?= $noinv ?>">
          </div>
          <div class="col-sm-12 text-right">
            ...
            if ($x1 > 0) {
            ?>
              <a href="?hapusAll=<?php echo $noinv ?>" onclick="javascript:return confirm('Anda yakin ingin menghapus semua data keranjang ?');" class="btn btn-danger btn-sm px-3 mr-2"><i class="fa fa-trash-alt mr-1"></i>Hapus Semua</a>
              <button name="import" class="btn btn-primary btn-sm px-3">
